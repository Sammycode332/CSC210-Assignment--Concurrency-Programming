 ...
 * @param topPapers     merged, de-duplicated, relevance-ranked papers (capped to top-N)
 * @param ranked        features in descending order of how many of those papers have them
 * @param summary       short synthesis of the relevant content (overview + key points)
...
public record TopicResult(
    ...
    public static TopicResult failed(String topic, String error) {
        return new TopicResult(topic, "", List.of(), List.of(), TopicSummary.empty(),
                0, 0, 0, 0, error);
    }
}
